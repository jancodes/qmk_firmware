...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             LT(1, KC_BSLASH), MO(3),   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    ...
    [3] = LAYOUT_65_ansi_blocker(
        ...
        _______, RGB_SPD, RGB_VAI, RGB_SPI, RGB_HUI, RGB_SAI, U_T_AUTO, U_T_AGCR, NK_TOGG, DBG_TOG, KC_PSCR, KC_SLCK, KC_PAUS, _______, LCTL(LALT(KC_DEL)), \
        _______, RGB_RMOD,RGB_VAD, RGB_MOD, RGB_HUD, RGB_SAD, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, KC_PGUP,          _______, LGUI(LSFT(KC_RIGHT)), \
        _______, _______, RGB_TOG, _______, _______, MD_BOOT, _______, _______, _______, _______, KC_PGDN, _______,          _______, LGUI(LSFT(KC_LEFT)), \
        _______, _______, _______,                            _______,                            KC_RALT, _______, KC_RCTL, _______, _______  \
    ),
};
