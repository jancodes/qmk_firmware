...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        LT(2, KC_GRAVE), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, RGB_TOG, _______, _______, DBG_TOG, NK_TOGG, MD_BOOT, _______, _______, _______, KC_PGDN,          _______, _______, \
